...
def main():
    schema_dir = Path('/Users/gokazu/Desktop/code/ora2pg-conv-w-strands/cdk/scripts/schema_sample')
    all_objects = []
    ...
    with open(csv_file, 'w', newline='', encoding='utf-8') as f:
        writer = csv.DictWriter(f, fieldnames=['filename', 'object_type', 'object_name'])
        writer.writeheader()
